...
namespace lux
{
  ...
  class Matrix
  {
    ...
    Matrix(const double value) : range(10)
    {
      for(int i=0;i<3;i++)
      {
        for(int j=0;j<3;j++)
    ...
    Matrix(const Matrix& v) : range(10)
    {
      for(int i=0;i<3;i++)
      {
        for(int j=0;j<3;j++)
    ...
    Matrix(const double v[3][3]) : range(10)
    {
      for(int i=0;i<3;i++)
      {
        for(int j=0;j<3;j++)
    ...
    Matrix( const Vector r0, const Vector r1, const Vector r2 ) : range(10)
    {
       m[0][0] = r0[0];
       m[0][1] = r0[1];
       m[0][2] = r0[2];
