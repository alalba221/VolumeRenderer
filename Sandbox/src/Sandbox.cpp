...
public:
	...
	virtual void OnInit() override
	{
		...
		headSDF = Alalba::Translate<float>(headSDF, lux::Vector(0.0, 1.5, 0.0));
		...
		m_key->GenerateDSM(density_grid, lux::Vector(0, 0, 0), lux::Vector(4, 4, 4), { 513,513,513 }, 8, 0.03, 2.0);
		ALALBA_TRACE("Fill dsm");
		m_fill->GenerateDSM(density_grid, lux::Vector(0, 0, 0), lux::Vector(4, 4, 4), { 513,513,513 }, 8, 0.03, 2.0);
		ALALBA_TRACE("Rim dsm");
		m_rim->GenerateDSM(density_grid, lux::Vector(0, 0, 0), lux::Vector(4, 4, 4), { 513,513,513 }, 8, 0.03, 2.0);
...
private:
	...
	//std::shared_ptr<Alalba::SparseGridVolume<float>> m_dsm;

	//Alalba::ScalarField key_TL;
	//Alalba::ScalarField fill_TL;
	//Alalba::ScalarField rim_TL;
};
